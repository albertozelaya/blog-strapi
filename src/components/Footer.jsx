...
const Footer = () => {
  return (
    <div className="w-full bg-RED_DARKER text-gray-200 py-8 px-2">
      ...
      <div className="flex flex-col max-w-[1240px] px-2 py-4 m-auto justify-between sm:flex-row text-center text-gray-200 items-center">
        <p>2024 Blog Strapi, llc Todos los derechos reservados</p>
