"use strict";(self.webpackChunkmy_project=self.webpackChunkmy_project||[]).push([[2640],{94061:(j,m,t)=>{t.d(m,{a:()=>g});var i=t(63891),d=t(28672),a=t(5146);const o={color:!0,cursor:!0,height:!0,width:!0},g=i.Ay.div.withConfig({shouldForwardProp:(e,s)=>!o[e]&&s(e)})`
  // Font
...
`},30893:(j,m,t)=>{t.d(m,{o:()=>I});var i=t(63891);const d="alpha",a="beta",o="delta",g="epsilon",e="omega",s="pi",f="sigma",P=[d,a,o,g,e,s,f],y=({ellipsis:u=!1})=>u&&`
  ...
  `,U=({variant:u=e,theme:n})=>{switch(u){case d:return`
...
`,P=({label:y,children:U,...D})=>{const A=d.Children.toArray(U);return(0,i.jsx)(o.a,{"aria-label":y,...D,children:(0,i.jsx)(f,{as:"ol",children:d.Children.map(A,(I,u)=>{const n=A.length>1&&u+1<A.length;return(0,i.jsxs)(s.s,{inline:!0,as:"li",children:[I,n&&(0,i.jsx)(e,{})]})})})})};P.displayName="Breadcrumbs"},60043:(j,m,t)=>{t.d(m,{m:()=>o});var i=t(92132),d=t(94061),a=t(30893);const o=({children:g,isCurrent:e=!1,...s})=>(0,i.jsx)(d.a,{paddingLeft:2,paddingRight:2,paddingTop:1,paddingBottom:1,children:(0,i.jsx)(a.o,{variant:"pi",textColor:"neutral800",fontWeight:e?"bold":"normal","aria-current":e,...s,children:g})});o.displayName="Crumb"},92640:(j,m,t)=>{t.r(m),t.d(m,{ProvidersPage:()=>oe,default:()=>be});var i=t(92132),d=t(21272),a=t(44158),o=t(81926),g=t(50642),e=t(6479),s=t(53900),f=t(43242),P=t(57564),y=t(68065),U=t(32161),D=t(69564),A=t(53432),I=t(55794),u=t(43121),n=t(32559),_e=t(79318),ge=t(70768),se=t(34508),C=t(21270),z=t(57842),pe=t(96586),he=t(83314),me=t(19106),_=t(32474),fe=t(31708),Ee=t(39404),N=t(54894),H=t(74930),ve=t(37679),Pe=t(60043),Me=t(61535),r=t(33544),p=t(26504),Le=t(77965),l=t(12083);const Q=({description:E,disabled:K,intlLabel:L,error:x,name:b,onChange:W,placeholder:h,providerToEditName:T,type:O,value:M})=>{const{formatMessage:v}=(0,N.A)(),R=b==="noName"?`${window.strapi.backendURL}/api/connect/${T}/callback`:M,B=v({id:L.id,defaultMessage:L.defaultMessage},{provider:T,...L.values}),$=E?v({id:E.id,defaultMessage:E.defaultMessage},{provider:T,...E.values}):"";if(O==="bool")return(0,i.jsx)(a.l,{"aria-label":b,checked:M,disabled:K,hint:$,label:B,name:b,offLabel:v({id:"app.components.ToggleCheckbox.off-label",defaultMessage:"Off"}),onLabel:v({id:"app.components.ToggleCheckbox.on-label",defaultMessage:"On"}),onChange:w=>{W({target:{name:b,value:w.target.checked}})}});const J=h?v({id:h.id,defaultMessage:h.defaultMessage},{...h.values}):"",Z=x?v({id:x,defaultMessage:x}):"";return(0,i.jsx)(o.k,{"aria-label":b,disabled:K,error:Z,label:B,name:b,onChange:W,placeholder:J,type:O,value:R})};Q.defaultProps={description:null,disabled:!1,error:"",placeholder:null,value:""},Q.propTypes={description:r.shape({id:r.string.isRequired,defaultMessage:r.string.isRequired,values:r.object}),disabled:r.bool,error:r.string,intlLabel:r.shape({id:r.string.isRequired,defaultMessage:r.string.isRequired,values:r.object}).isRequired,name:r.string.isRequired,onChange:r.func.isRequired,placeholder:r.shape({id:r.string.isRequired,defaultMessage:r.string.isRequired,values:r.object}),providerToEditName:r.string.isRequired,type:r.string.isRequired,value:r.oneOfType([r.bool,r.string])};const V=({headerBreadcrumbs:E,initialData:K,isSubmiting:L,layout:x,isOpen:b,onSubmit:W,onToggle:h,providerToEditName:T})=>{const{formatMessage:O}=(0,N.A)();return b?(0,i.jsxs)(g.k,{onClose:h,labelledBy:"title",children:[(0,i.jsx)(e.r,{children:(0,i.jsx)(ve.B,{label:E.join(", "),children:E.map((M,v,R)=>(0,i.jsx)(Pe.m,{isCurrent:v===R.length-1,children:M},M))})}),(0,i.jsx)(Me.l1,{onSubmit:M=>W(M),initialValues:K,validationSchema:x.schema,validateOnChange:!1,children:({errors:M,handleChange:v,values:R})=>(0,i.jsxs)(_.lV,{children:[(0,i.jsx)(s.c,{children:(0,i.jsx)(f.s,{direction:"column",alignItems:"stretch",gap:1,children:(0,i.jsx)(P.x,{gap:5,children:x.form.map(B=>B.map($=>(0,i.jsx)(y.E,{col:$.size,xs:12,children:(0,i.jsx)(Q,{...$,error:M[$.name],onChange:v,value:R[$.name],providerToEditName:T})},$.name)))})})}),(0,i.jsx)(U.j,{startActions:(0,i.jsx)(D.$,{variant:"tertiary",onClick:h,type:"button",children:O({id:"app.components.Button.cancel",defaultMessage:"Cancel"})}),endActions:(0,i.jsx)(D.$,{type:"submit",loading:L,children:O({id:"global.save",defaultMessage:"Save"})})})]})})]}):null};V.defaultProps={initialData:null,providerToEditName:null},V.propTypes={headerBreadcrumbs:r.arrayOf(r.string).isRequired,initialData:r.object,layout:r.shape({form:r.arrayOf(r.array),schema:r.object}).isRequired,isOpen:r.bool.isRequired,isSubmiting:r.bool.isRequired,onSubmit:r.func.isRequired,onToggle:r.func.isRequired,providerToEditName:r.string};const te={id:(0,p.g)("PopUpForm.Providers.redirectURL.front-end.label"),defaultMessage:"The redirect URL to your front-end app"},ie={id:"http://www.client-app.com",defaultMessage:"http://www.client-app.com"},k={id:(0,p.g)("PopUpForm.Providers.enabled.description"),defaultMessage:"If disabled, users won't be able to use this provider."},G={id:(0,p.g)("PopUpForm.Providers.enabled.label"),defaultMessage:"Enable"},ae={id:(0,p.g)("PopUpForm.Providers.key.label"),defaultMessage:"Client ID"},ne={id:(0,p.g)("PopUpForm.Providers.redirectURL.label"),defaultMessage:"The redirect URL to add in your {provider} application configurations"},S={id:(0,p.g)("PopUpForm.Providers.key.placeholder"),defaultMessage:"TEXT"},re={id:(0,p.g)("PopUpForm.Providers.secret.label"),defaultMessage:"Client Secret"},X={email:{form:[[{intlLabel:G,name:"enabled",type:"bool",description:k,size:6}]],schema:l.Ik().shape({enabled:l.lc().required(_.iW.required)})},providers:{form:[[{intlLabel:G,name:"enabled",type:"bool",description:k,size:6,validations:{required:!0}}],[{intlLabel:ae,name:"key",type:"text",placeholder:S,size:12,validations:{required:!0}}],[{intlLabel:re,name:"secret",type:"text",placeholder:S,size:12,validations:{required:!0}}],[{intlLabel:te,placeholder:ie,name:"callback",type:"text",size:12,validations:{required:!0}}],[{intlLabel:ne,name:"noName",type:"text",validations:{},size:12,disabled:!0}]],schema:l.Ik().shape({enabled:l.lc().required(_.iW.required),key:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()}),secret:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()}),callback:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()})})},providersWithSubdomain:{form:[[{intlLabel:G,name:"enabled",type:"bool",description:k,size:6,validations:{required:!0}}],[{intlLabel:ae,name:"key",type:"text",placeholder:S,size:12,validations:{required:!0}}],[{intlLabel:re,name:"secret",type:"text",placeholder:S,size:12,validations:{required:!0}}],[{intlLabel:{id:(0,p.g)({id:"PopUpForm.Providers.jwksurl.label"}),defaultMessage:"JWKS URL"},name:"jwksurl",type:"text",placeholder:S,size:12,validations:{required:!1}}],[{intlLabel:{id:(0,p.g)("PopUpForm.Providers.subdomain.label"),defaultMessage:"Host URI (Subdomain)"},name:"subdomain",type:"text",placeholder:{id:(0,p.g)("PopUpForm.Providers.subdomain.placeholder"),defaultMessage:"my.subdomain.com"},size:12,validations:{required:!0}}],[{intlLabel:te,placeholder:ie,name:"callback",type:"text",size:12,validations:{required:!0}}],[{intlLabel:ne,name:"noName",type:"text",validations:{},size:12,disabled:!0}]],schema:l.Ik().shape({enabled:l.lc().required(_.iW.required),key:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()}),secret:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()}),subdomain:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()}),callback:l.Yj().when("enabled",{is:!0,then:l.Yj().required(_.iW.required),otherwise:l.Yj()})})}},oe=()=>{const{formatMessage:E,locale:K}=(0,N.A)(),L=(0,H.useQueryClient)(),{trackUsage:x}=(0,_.z1)(),[b,W]=d.useState(!1),[h,T]=d.useState(null),O=(0,_.hN)(),{lockApp:M,unlockApp:v}=(0,_.MA)(),{get:R,put:B}=(0,_.ry)(),{formatAPIError:$}=(0,_.wq)(),J=(0,_.QM)(K,{sensitivity:"base"});(0,_.L4)();const{isLoading:Z,allowedActions:{canUpdate:w}}=(0,_.ec)({update:p.P.updateProviders}),{isLoading:ye,data:q}=(0,H.useQuery)(["users-permissions","get-providers"],async()=>{const{data:c}=await R("/users-permissions/providers");return c},{initialData:{}}),de=(0,H.useMutation)(c=>B("/users-permissions/providers",c),{async onSuccess(){await L.invalidateQueries(["users-permissions","providers"]),O({type:"success",message:{id:(0,p.g)("notification.success.submit")}}),x("didEditAuthenticationProvider"),ee(),v()},onError(c){O({type:"warning",message:$(c)}),v()},refetchActive:!1}),Y=Object.entries(q).reduce((c,[F,Oe])=>{const{icon:ue,enabled:je,subdomain:Ae}=Oe;return c.push({name:F,icon:ue==="envelope"?["fas","envelope"]:["fab",ue],enabled:je,subdomain:Ae}),c},[]).sort((c,F)=>J.compare(c.name,F.name)),xe=ye||Z,le=d.useMemo(()=>h?!!Y.find(F=>F.name===h)?.subdomain:!1,[Y,h]),$e=d.useMemo(()=>h==="email"?X.email:le?X.providersWithSubdomain:X.providers,[h,le]),ee=()=>{W(c=>!c)},ce=c=>{w&&(T(c.name),ee())},De=async c=>{M(),x("willEditAuthenticationProvider"),de.mutate({providers:{...q,[h]:c}})};return(0,i.jsxs)(A.P,{children:[(0,i.jsx)(_.x7,{name:E({id:(0,p.g)("HeaderNav.link.providers"),defaultMessage:"Providers"})}),(0,i.jsxs)(I.g,{children:[(0,i.jsx)(u.Q,{title:E({id:(0,p.g)("HeaderNav.link.providers"),defaultMessage:"Providers"})}),xe?(0,i.jsx)(_.Bl,{}):(0,i.jsx)(n.s,{children:(0,i.jsxs)(_e.X,{colCount:3,rowCount:Y.length+1,children:[(0,i.jsx)(ge.d,{children:(0,i.jsxs)(se.Tr,{children:[(0,i.jsx)(C.Th,{children:(0,i.jsx)(z.o,{variant:"sigma",textColor:"neutral600",children:E({id:"global.name",defaultMessage:"Name"})})}),(0,i.jsx)(C.Th,{children:(0,i.jsx)(z.o,{variant:"sigma",textColor:"neutral600",children:E({id:(0,p.g)("Providers.status"),defaultMessage:"Status"})})}),(0,i.jsx)(C.Th,{children:(0,i.jsx)(z.o,{variant:"sigma",children:(0,i.jsx)(pe.s,{children:E({id:"global.settings",defaultMessage:"Settings"})})})})]})}),(0,i.jsx)(he.N,{children:Y.map(c=>(0,i.jsxs)(se.Tr,{...(0,_.qM)({fn:()=>ce(c),condition:w}),children:[(0,i.jsx)(C.Td,{width:"45%",children:(0,i.jsx)(z.o,{fontWeight:"semiBold",textColor:"neutral800",children:c.name})}),(0,i.jsx)(C.Td,{width:"65%",children:(0,i.jsx)(z.o,{textColor:c.enabled?"success600":"danger600","data-testid":`enable-${c.name}`,children:c.enabled?E({id:"global.enabled",defaultMessage:"Enabled"}):E({id:"global.disabled",defaultMessage:"Disabled"})})}),(0,i.jsx)(C.Td,{..._.dG,children:w&&(0,i.jsx)(me.K,{onClick:()=>ce(c),noBorder:!0,icon:(0,i.jsx)(fe.A,{}),label:"Edit"})})]},c.name))})]})})]}),(0,i.jsx)(V,{initialData:q[h],isOpen:b,isSubmiting:de.isLoading,layout:$e,headerBreadcrumbs:[E({id:(0,p.g)("PopUpForm.header.edit.providers"),defaultMessage:"Edit Provider"}),Ee(h)],onToggle:ee,onSubmit:De,providerToEditName:h})]})},be=()=>(0,i.jsx)(_.kz,{permissions:p.P.readProviders,children:(0,i.jsx)(oe,{})})}}]);
